...
#define TASK_STATE_INIT		0 //�½�ũ�� �ʱ�ȭ�� ����
#define TASK_STATE_WAIT		1 //������ ���� ������� ����
#define TASK_STATE_RUNNING	2 //�½�ũ�� �������� ����
#define TASK_STATE_SLEEP	3 //�½�ũ�� �½�ũ �����췯���� ���ܵ� ����
#define TASK_STATE_END		4 //�½�ũ�� ����� ����   

#define TASK_RUNNING_TIME 4   //�½�ũ�� CPU�� ����ϴ� �ð�
