...
// Page table 이 표현할 수 있는 Page 의 수 = 2^10
...
// Virtual address 에서 Page Table index 를 얻음
...
// Page Directory : Process 마다 1개의 Page Directory 를 가지고 있음
...
namespace VirtualMemoryManager
{
	...
	// Kernel 과의 mapping 수행
	void SetPageDirectory(PageDirectory* dir);

	//페이지 디렉토리를 PDBR (Page Directory Base Register) 레지스터에 세트한다
	...
	// 주소로부터 PTE (Page Table Entry) 를 얻어온다
	...
	// 주소로부터 Page Directory Entry 를 얻어온다	
	...
	// 페이지 디렉토리를 생성한다. 즉 가상 주소 공간을 생성한다는 의미다
