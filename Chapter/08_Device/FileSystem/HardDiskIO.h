...
{
	BYTE IORegisterIdx;  // IO Resource 와 IRQ index number
	BYTE IRQ;
	...
	BYTE DeviceID[512];		// device identification comamnd 로 부터 얻은 device id
	...
	UINT32 LBACount; // LBA mode 에서만 사용 

	UINT16 BytesPerSector; // Sector 당 byte 수
